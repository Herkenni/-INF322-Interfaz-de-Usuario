  ...
  return (
    <div className="modal">
      <div className="modal-content">
        ...
        <button style={{position:'relative',height: 50,width:50, left:-100, top:-20, backgroundColor:'rgb(255,100,100)'}} onClick={onClose}>
            <img style={{height:30,width:30}} src={Close}/>
        </button>
        <button style={{position:'relative',height: 50,width:50, left:-20, top:-20, backgroundColor:'rgb(0,100,0)', borderRadius:'50%', pointerEvents: 'none'}}>
